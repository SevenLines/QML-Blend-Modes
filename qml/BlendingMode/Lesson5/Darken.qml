...
if (above1 && above2) {
    gl_FragColor.r =  min(inActiveImgFrag.r,activeImgFrag.r);
    gl_FragColor.g =  min(inActiveImgFrag.g,activeImgFrag.g);
    gl_FragColor.b =  min(inActiveImgFrag.b,activeImgFrag.b);
    gl_FragColor.a = 1.0;
    return;
}
if (above1) {
